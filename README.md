...
Este projeto é uma aplicação de busca de produtos integrada à API do Mercado Livre com testes automatizados e com a biblioteca de segurança DOMpurify para um desafio de entrada em um projeto.
 Ao acessar o link você vai abrir uma tela de login fake com dados mockados e vai ter que conectar sua conta do Mercado Livre na aplicação para acessr dados reais.
...
- Uma aplicação criada com base no https://developers.mercadolivre.com.br/pt_br/api-docs-pt-br
